...
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/shampeon/antora-ui
:url-preview: https://.io/antora-ui
:url-ci-pipelines: {url-project}/actions/workflows
:img-ci-status: {url-project}/actions/workflows/bundle.yaml/badge.svg
// External URLs:
...
This project is a custom {url-antora-docs}[Antora] https://docs.antora.org/antora-ui-default/[UI] for https://docs.techne.net[docs.techne.net], the demo site for Ian Evans work as a technical writer.
