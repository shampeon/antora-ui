...
This project is a custom {url-antora-docs}[Antora] https://docs.antora.org/antora-ui-default/[UI] for docs.techne.net, the demo site for Ian Evans work as a technical writer.
